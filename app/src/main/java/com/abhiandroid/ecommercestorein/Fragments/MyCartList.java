...
import com.abhiandroid.ecommercestorein.Adapters.CartListAdapter;
import com.abhiandroid.ecommercestorein.Config;
import com.abhiandroid.ecommercestorein.Activities.Login;
import com.abhiandroid.ecommercestorein.MVP.CartistResponse;
...
import com.abhiandroid.ecommercestorein.Activities.SignUp;
...
public class MyCartList extends Fragment {
        ...
        proceedToPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(loadData()!=1){
                    ...
                    Toast.makeText(getContext(),"Please Confirm your Address and try again.",Toast.LENGTH_SHORT).show();
                }else
                {
    ...
    public int loadData(){
        SharedPreferences sharedPreferences=this.getActivity().getSharedPreferences("profile",MODE_PRIVATE);
        return  sharedPreferences.getInt("statusp",MODE_PRIVATE);
    }
}
