...
import com.abhiandroid.ecommercestorein.Activities.AccountVerification;
import com.abhiandroid.ecommercestorein.Adapters.ColorListAdapter;
import com.abhiandroid.ecommercestorein.Adapters.DetailPageSliderPagerAdapter;
import com.abhiandroid.ecommercestorein.Adapters.DotsAdapter;
import com.abhiandroid.ecommercestorein.Adapters.MyPagerAdapter;
import com.abhiandroid.ecommercestorein.Adapters.SizeListAdapter;
import com.abhiandroid.ecommercestorein.Config;
import com.abhiandroid.ecommercestorein.MVP.AddToWishlistResponse;
...
import com.abhiandroid.ecommercestorein.Retrofit.Api;
...
//        productList.addAll(SplashScreen.categoryListResponseData.get(parentPosition).getProducts());
        ...
        abc=productList.get(position).getDescription();
        int length=abc.length();

        description=abc.substring(3,length-6);
    ...
    public void speak(){
        if(sizeList.size()==1){
            if(sizeList.get(0).equals("S")){
                sizes="Small";
            }else if (sizeList.get(0).equals("M")){
                sizes="Medium";
            }else {
                sizes="Large";
            }
        }else if(sizeList.size()==2){
            if(sizeList.get(0).equals("S") && sizeList.get(1).equals("M")){
                sizes="Small,Medium";
            }else if(sizeList.get(0).equals("M") && sizeList.get(1).equals("L")){
                sizes="Medium,Large";
            }else {
                sizes="Small,Large";
            }
        ...
        String text="The name of Product is "+textViews.get(0).getText().toString()
                +". The price of product is "+textViews.get(1).getText().toString()
                +". There is "+textViews.get(3).getText().toString()
                +" on product. The product is "+textViews.get(5).getText().toString()
                +" . Remaining products are "+productsr+". Availible sizes of product are "
                +sizes+". Availible colors are "+colorList.toString()+". The description of product is "+description;
//        Toast.makeText(getActivity(), String.valueOf(sizeList.size()) , Toast.LENGTH_SHORT).show();
